...
SUBSTANCECORE_API void CreateSubstanceTexture2D(SubstanceAir::OutputInstance* output, bool bTransient = false,
        FString Name = FString(), UObject* InOuter = NULL, USubstanceGraphInstance* ParentInst = NULL);
...
SUBSTANCECORE_API TWeakObjectPtr<UMaterial> CreateMaterial(USubstanceGraphInstance* Instance, const FString& MatName, UObject* Outer = NULL);

/** Sets all of the material inputs to the proper outputs from a graph instance */
SUBSTANCECORE_API void ResetMaterialTexturesFromGraph(USubstanceGraphInstance* Graph, UMaterial* OwnedMaterial, TArray<MaterialParameterSet>& Materials);
...
SUBSTANCECORE_API void GetSuitableName(SubstanceAir::OutputInstance* Instance,
                                       FString& OutTextureName, FString& OutPackageName, USubstanceGraphInstance* OptionalParentGraph = NULL);
